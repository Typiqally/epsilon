        ...
        public async Task GivenAllowedModulesAndCourseId_WhenModuleAndOutcomeServiceAreMocked_ThenReturnsExpectedModuleOutcomeResultCollection()
        {
            ...
            var expectedResults = new List<ModuleOutcomeResultCollection>
            {
                new ModuleOutcomeResultCollection(
                    new CourseModule(1, "Module 1", 3, new List<ModuleItem>
                    {
                ...
                new ModuleOutcomeResultCollection(
                    new CourseModule(3, "Module 3", 2, new List<ModuleItem>
                    {
                        new ModuleItem(4, "Module 3 Item 1", ModuleItemType.Assignment, 4), new ModuleItem(5, "Module 3 Item 2", ModuleItemType.Assignment, 5),
                    }),
                    new OutcomeResultCollection(
                        new List<OutcomeResult>
                        {
            ...
            outcomeServiceMock
                .Setup(static s => s.GetResults(It.IsAny<int>(), It.IsAny<string[]>()))
            ...
            moduleServiceMock
                .Setup(static s => s.GetAll(It.IsAny<int>(), It.IsAny<string[]>()))
                .ReturnsAsync(new List<CourseModule>
                {
                    new CourseModule(1, "Module 1", 3, new List<ModuleItem>
                    {
                        new ModuleItem(1, "Module 1 Item 1", ModuleItemType.Page, 1),
                    ...
                    new CourseModule(2, "Module 2", 0, new List<ModuleItem>()),
                    new CourseModule(3, "Module 3", 2, new List<ModuleItem>
                    {
                        new ModuleItem(4, "Module 3 Item 1", ModuleItemType.Assignment, 4), new ModuleItem(5, "Module 3 Item 2", ModuleItemType.Assignment, 5),
                    }),
